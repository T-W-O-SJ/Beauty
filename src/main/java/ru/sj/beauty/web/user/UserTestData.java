...
public class UserTestData {
    ...
    public static final User USER = new User(USER_ID, "User","89151551155", "user@yandex.ru", "password",Role.ROLE_USER);
    public static final User ADMIN = new User(ADMIN_ID, "Admin","8915119418","admin@gmail.com", "admin", Role.ROLE_ADMIN);
