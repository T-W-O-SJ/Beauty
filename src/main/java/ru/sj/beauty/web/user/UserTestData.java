...
public class UserTestData {
    ...
    public static final User USER = new User(USER_ID, "User","user@yandex.ru", 89151194184, "password",Role.ROLE_USER);
    public static final User ADMIN = new User(ADMIN_ID, "Admin","admin@gmail.com",8916114141, "admin", Role.ROLE_ADMIN);
